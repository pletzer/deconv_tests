...
{    
    ...
    // FFTW plan
    fftw_plan p = fftw_plan_dft_3d(SIGNAL_SIZE, SIGNAL_SIZE, SIGNAL_SIZE, d_signal, d_signal2, FFTW_FORWARD, FFTW_ESTIMATE);
    fftw_plan p2 = fftw_plan_dft_3d(SIGNAL_SIZE, SIGNAL_SIZE, SIGNAL_SIZE, d_signal2, d_signal, FFTW_BACKWARD, FFTW_ESTIMATE);
